...
for item in titles:
    ...
    for i in range(0, len(sales[item_code])):
        total_quantity += sales[item_code][i]['quantity']
        total_cost += sales[item_code][i]['quantity']*sales[item_code][i]['price']
 
    print(item_name, '- количество',  total_quantity, 'шт., общая стоимость ', total_cost, 'руб.')